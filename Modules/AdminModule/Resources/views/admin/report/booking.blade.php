                            ...
                            <div class="table-responsive">
                                <table id="example" class="table align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{translate('Serviceman_info')}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (isset($booking->serviceman))
                                                    <div class="ps-2">{{$booking->serviceman?->user?->first_name}} {{$booking->serviceman?->user?->last_name}}</div>
                                                
                                                @else
                                                <div
                                                class="fw-medium badge badge badge-danger radius-50">{{translate('Serviceman_not_available')}}</div>
                                                @endif
                                            </td>
                                            <td>{{ $booking->subCategory->name }}</td>
                                            <td>{{ $booking->detail[0]->service_name }}</td>
