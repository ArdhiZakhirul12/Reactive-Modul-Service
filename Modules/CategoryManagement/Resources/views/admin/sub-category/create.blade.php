...
@section('title',translate('pengaturan mesin'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('Pengaturan_mesin')}}</h2>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="d-flex flex-column">
                                            {{-- <select class="js-select theme-input-style w-100" name="parent_id">
                                                <option value="0" selected
                                                        disabled>{{translate('Select Machine Category')}}</option>
                                                ...
                                                <div class="lang-form" id="default-form">
                                                    <div class="form-floating form-floating__icon mb-30">
                                                        <input type="text" name="name[]" class="form-control"
                                                               placeholder="{{translate('nama mesin')}}" required
                                                        >
                                                        <label>{{translate('nama mesin')}}
                                                            </label>
                                                ...
                                                @foreach ($language?->live_values as $lang)
                                                    <div class="lang-form d-none" id="{{ $lang['code'] }}-form">
                                                        <div class="form-floating form-floating__icon mb-30 mt-30">
                                                            <input type="text" name="name[]" class="form-control"
                                                                   placeholder="{{translate('machine_name')}} ">
                                                            <label>{{translate('machine_name')}}
                                            ...
                                            @else
                                                <div class="form-floating mb-30 mt-30 lang-form">
                                                    <input type="text" name="name[]" class="form-control"
                                                           value="{{old('name')}}"
                                                           placeholder="{{translate('machine_name')}}" required>
                                                    <label>{{translate('machine_name')}}
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end gap-20 mt-30">
                                            ...
                                            <button class="btn btn--primary" type="submit">{{translate('simpan')}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div class="d-flex gap-2 fw-medium">
                            <span class="opacity-75">{{translate('Total_Mesin')}}:</span>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table align-middle">
                                            ...
                                            <tr>
                                                ...
                                                {{-- <th>{{translate('machine_category')}}</th> --}}
