...
class CustomerController extends Controller
{
    ...
    private DetailCustomerMachine $detailCustomerMachine;
    private Review $review;
    private UserAddress $address;

    public function __construct(Booking $booking, User $user, Review $review, UserAddress $address, CustomerMachine $customerMachine, DetailCustomerMachine $detailCustomerMachine)
    {
        $this->booking = $booking;
        $this->user = $user;
        $this->review = $review;
        $this->address = $address;
        $this->detailCustomerMachine = $detailCustomerMachine;
    ...
    public function show($id, Request $request)
    {
        ...
        if ($request->web_page == 'overview') {
            ...
            $mesin = $this->customerMachine->where('user_id',$customer->id)->with('detail_customer_machine.category')->first();
            // dd($mesin);

            return view('customermodule::admin.detail.overview', compact('customer', 'totalBookingAmount', 'webPage', 'total','mesin'));
