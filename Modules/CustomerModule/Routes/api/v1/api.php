...
use Modules\CustomerModule\Http\Controllers\Api\V1\Customer\CustomerMachineController;
...
Route::group(['prefix' => 'customer', 'as' => 'customer.', 'namespace' => 'Api\V1\Customer'], function () {
    ...
    Route::resource('customer-machine', 'CustomerMachineController', ['only' => ['index', 'store', 'edit', 'update', 'destroy']])->withoutMiddleware(['api:auth']);
