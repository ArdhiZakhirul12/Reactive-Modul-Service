            ...
            <div class="card">
                <div class="card-body p-30">
                    ...
                    <div class="">
                        ...
                        @endif
                        {{-- @dd($mesin) --}}
                        @if($mesin && $mesin->detail_customer_machine->count() > 0)
                            <div class="information-details-box customer-address">
                                @foreach($mesin->detail_customer_machine as $mesin)
                                    <div class="d-flex justify-content-between gap-2 mb-20">
                                        <div class="media gap-2 gap-xl-3">
                                            <span class="material-icons c1">print</span>
                                            <div class="media-body">
                                                <h4 class="fw-medium mb-1">{{$mesin->category->name}}</h4>
                                                <div class="text-muted">no seri: {{ Str::limit($mesin->serial_number, 100) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
