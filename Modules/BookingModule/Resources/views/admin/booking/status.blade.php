            ...
            <div class="pb-3 d-flex justify-content-between align-items-center gap-3 flex-wrap">
                ...
                <div class="d-flex flex-wrap flex-xxl-nowrap gap-3">
                    ...
                    <span class="material-icons">done</span>{{translate('Change Request Status')}}
                        ...
                        @if(in_array($booking['booking_status'], ['pending', 'accepted', 'ongoing','pendingSparepart','reschedule']) && $booking->booking_partial_payments->isEmpty())
                        ...
                        <a href="{{route('admin.booking.invoice',[$booking->id])}}"
                           class="btn btn-primary" target="_blank">
                            <span class="material-icons">description</span>{{translate('SPK')}}
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <div
                                    ...
                                    <div class="text-start text-sm-end">
                                        <p class="mb-2">
                                            ...
                                            <span class="badge badge badge-{{$booking->is_paid?'success':'danger'}} radius-50 text-center">
                                                    <span class="dot"></span>
                                ...
                                <div class="timeline-steps m-0">
                                    ...
                                    @foreach($booking->status_histories as $status_history)
                                        <div class="timeline-step completed">
                                            ...
                                            <div class="timeline-info">
                                                <p  data-status="{{ $status_history->booking_status }}" class="status-get-loop timeline-title text-capitalize">{{$status_history->booking_status}}</p>
                            ...
                            <div class="py-3 d-flex flex-column gap-3 mb-2">
                                ...
                                <div class="c1-light-bg radius-10 provider-information">
                                    ...
                                    @else
                                        <div class="d-flex flex-column gap-2 mt-30 align-items-center">
                                            ...
                                            <p class="text-muted text-center fw-medium mb-3">{{translate('Belum ada informasi')}}</p>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="c1-light-bg radius-10 serviceman-information">
                                    ...
                                    @else
                                        <div class="d-flex flex-column gap-2 mt-30 align-items-center">
                                            <span class="material-icons text-muted fs-2">account_circle</span>
                                            <p class="text-muted text-center fw-medium mb-3">{{translate('Belum ada teknisi')}}</p>
                                        </div>
                                    @endif
                                </div>
                                <div class="c1-light-bg radius-10 flex-grow-1">
                                    ...
                                    @if(isset($booking->serviceman_note))
                                    <div class="py-3 px-4">
                                        <div class="media gap-2 flex-wrap">
                                            <div class="media-body">                                        
                                                <ul class="list-info">
                                                    <li>    
                                                        <span class="wrap-text"> {{$booking->serviceman_note}} </span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
    var statusElements = document.querySelectorAll('.status-get-loop');
