...
class BookingController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $bookings = $this->booking
            ->with(['customer', 'subCategory:id,name', 'serviceman.users', 'booking_offline_payments' => function ($query) {
                    $query->first() ?? [];
            }])
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        $booking = $this->booking->with([
            'detail.service', 'schedule_histories.user', 'status_histories.user', 'service_address', 'customer', 'provider', 'zone', 'serviceman.user', 'booking_partial_payments', 'booking_offline_payments', 'subCategory' => function ($q) {
