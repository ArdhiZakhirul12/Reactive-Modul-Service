...
class BookingController extends Controller
{
    ...
    public function index(Request $request): Renderable
    {
        ...
        $bookings = $this->booking
            ->with(['customer', 'customRequestBooking.customRequest','reschedule', 'status_histories' => function ($q) {
                $q->where('booking_status', 'customerAgrees');
            }])
    ...
    public function invoice($id, Request $request): Renderable
    {
        ...
        // return view('bookingmodule::admin.booking.invoice', compact('booking','subCategory'));
        // dd($booking);
