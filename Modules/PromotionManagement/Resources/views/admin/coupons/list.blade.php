...
@section('title',translate('warranties'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('warranty')}}</h2>
                    </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{$discountType=='category'?'active':''}}"
                                   href="{{url()->current()}}?discount_type=category">
                                    {{translate('machine_category_wise')}}
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <table id="example" class="table align-middle">
                                    <thead class="text-nowrap">
                                        <tr>
                                            ...
                                            <th>{{translate('warranty_type')}}</th>
                                            <th>{{translate('warranty_code')}}</th>
