            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{ translate('Notifikasi Blasting') }}</h2>
                    </div>
                                    ...
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                @foreach ($zones as $zone)
                                                    <span class="zone-id" data-id="{{ $zone->id }}"></span>
                                                @endforeach
                                                <div id="zone_selector__container"></div>
                                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($pushNotification as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->title }}</td>
                                                        <td>
                                                            <img src="{{ asset('storage/app/public/push-notification') }}/{{ $item->cover_image }}"
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            var zoneIds = [];
            $('.zone-id').each(function() {
                zoneIds.push($(this).data('id'));
            });
    
            // Bersihkan container sebelum menambahkan input baru
            $('#zone_selector__container').empty();
    
            // Tambahkan input hidden untuk setiap zona ID
            zoneIds.forEach(function(id) {
                $('#zone_selector__container').append(
