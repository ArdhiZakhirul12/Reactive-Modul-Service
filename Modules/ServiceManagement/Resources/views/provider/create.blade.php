            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('tambah servis baru')}}</h2>
                    </div>
                        ...
                        <div class="card-body p-30">
                            <div>
                                ...
                                <form action="{{route('provider.service.store')}}" method="post"           enctype="multipart/form-data"
                                    ...
                                    {{-- <h3>{{translate('informasi servis')}}</h3> --}}
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-5 mb-5 mb-lg-0">
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-error-wrap">
                                                        <select class="js-select theme-input-style w-100 form-error-wrap" name="sub_category_id" id="category-id">
                                                            <option value="0" selected
                                                                    disabled>{{translate('pilih_mesin')}} *
                                                            </option>
                                    ...
                                    <div class="d-flex pt-4 gap-4 flex-wrap justify-content-end">                                        
                                        <button type="submit" class="btn btn--primary">{{translate('Submit')}}</button>
                                    </div>
                                    {{-- <h3>{{translate('variasi')}}</h3>
                                    <section>
                                        <div class="d-flex flex-wrap gap-20 mb-3">
                                            ...
                                            <input type="hidden" class="form-control" name="variant_price"
                                                   id="variant-price"
...
@push('script')
    ...
    <script>
        ...
        $("#service-ajax-variation").on('click', function (){
            let route = "{{route('provider.service.ajax-add-variant')}}";
        ...
        $("#category-id").change(function (){
            let id = this.value;
            let route = "{{ url('/provider/service/ajax-childes/') }}/" + id;
