                                                ...
                                                <div class="service-list-item">
                                                    <div class="service-img">
                                                        <a>
                                                                ...
                                                                <img src="{{asset('public/assets/admin-module/img/media/mesin2.png')}}" alt="">
                                ...
                                <li class="d-flex flex-column gap-2 justify-content-center service_cursor_pointer provider-service-detail"
                                    ...
                                    {{-- <img alt="{{translate('image')}}"
                                        ...
                                        'service/')}}"
                                         ...
                                         <img src="{{asset('public/assets/admin-module/img/media/mesin2.png')}}" class="mx-auto img-square-90" width="90">
                                    <div class="fw-medium">
