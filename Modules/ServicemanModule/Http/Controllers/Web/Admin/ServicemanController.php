...
class ServicemanController extends Controller
{
    ...
    public function index(Request $request): Renderable
    {
        ...
        return view('servicemanmodule::Admin.Serviceman.list', compact('servicemen', 'search', 'status'));
    }
    ...
    public function create(Request $request): Renderable
    {
        ...
        return view('servicemanmodule::Admin.Serviceman.create', compact('providers'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        DB::transaction(function () use ($request, $identityImages) {
            ...
            $serviceman->provider_id = $request->provider_id;
    ...
    public function show(Request $request, string $id): View|Factory|RedirectResponse|Application
    {
        ...
        return view('servicemanmodule::Admin.Serviceman.details', compact('serviceman', 'chartdata', 'dateRange', 'totalAssignedBookings'));
    }
    ...
    public function edit(string $id): Application|Factory|View
    {
        ...
        $providers = Provider::all();
        return view('servicemanmodule::Admin.Serviceman.edit', compact('serviceman', 'providers'));
    }
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        DB::transaction(function () use ($request, $identityImages, $employee , $serviceman) {
            $serviceman->update(['provider_id' => $request->provider_id]);
