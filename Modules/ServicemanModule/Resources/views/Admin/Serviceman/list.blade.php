                                        ...
                                        <div class="d-flex flex-wrap align-items-center gap-3">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                    <li>
                                                        <a class="dropdown-item" href="{{route('admin.serviceman.download',['status' => $status, 'search'=>$search])}}">
                                                            {{translate('excel')}}
                                                        </a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table align-middle">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{translate('vice_of_technician')}}</th>
                                            ...
                                            @foreach($servicemen as $key=>$serviceman)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.provider.details', [$serviceman->serviceman->provider_id, 'web_page'=>'overview'])}}">
                                                            {{Str::limit($serviceman->serviceman->provider->company_name, 40)}} <br/>
                                                            {{ $serviceman->serviceman->provider->contact_person_phone }} <br/>
                                                            {{ $serviceman->serviceman->provider->contact_person_email }}
                                                        </a>
                                                    </td>
                                                    <td>
                                                        {{$serviceman->email}} <br/>
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            ...
                                                            <form
                                                                action="{{route('admin.serviceman.delete', [$serviceman->serviceman->id])}}"
                                                                method="post"
