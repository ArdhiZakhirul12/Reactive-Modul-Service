        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('admin.serviceman.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row gx-xl-5">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select select-identity theme-input-style mb-30" name="identity_type" required>
                                        ...
                                        {{-- pilih wakil teknisi --}}
                                        <select class="form-select select-identity theme-input-style mb-30" name="provider_id" required>
                                            <option disabled selected>{{translate('Select_Vice_of_Technician')}}</option>
