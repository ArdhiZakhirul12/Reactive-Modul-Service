        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('admin.serviceman.update',[$serviceman->id])}}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="select-identity theme-input-style w-100 mb-30"
                                            ...
                                            @foreach($providers as $provider)
                                                <option
                                                    value="{{$provider->id}}" {{$provider->id==$serviceman->provider_id?'selected':''}}>{{$provider->company_name}}</option>
                                            @endforeach
                                        </select>
