                            ...
                            <div class="d-flex gap-3 align-items-center justify-content-end">
                                <label class="switcher">
                                    <input class="switcher_input service-man-update"
                                           type="checkbox" {{$serviceman->user->is_active?'checked':''}} data-route="{{route('admin.serviceman.status-update',[$serviceman->user->id])}}" data-message="{{translate('want_to_update_status')}}">
                                    <span class="switcher_control"></span>
                                </label>
                                <a type="button" class="bg-transparent border-0 p-0 lh-1"
                                   href="{{route('admin.serviceman.edit', [$serviceman->id])}}">
                                ...
                                <form
                                    action="{{route('admin.serviceman.delete', [$serviceman->id])}}"
                                    method="post"
...
@push('script')
    ...
    <script>
        ...
        $("#date-range").change(function () {
            location.href = "{{route('admin.serviceman.show', [$serviceman->id])}}?date_range=" + $(this).val();
        });
