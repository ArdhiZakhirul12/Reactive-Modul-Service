...
class CustomRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // \dd([$customRequest]);
        return view('bidmodule::provider.customize-list', compact('customRequest','custom_request_status'));
    }
    ...
    public function show($id)
    {
        ...
        $provider_zone = Provider::select('zone_id')->where('user_id',Auth::id())->first();
        ...
        // \dd($provider);
        return view('bidmodule::provider.details', compact('post','provider_zone','machines','services'));
    }
    ...
    public function rejectCustomRequest(Request $request, $id) {
        ...
        if ($response['flag'] == 'success') {
            return redirect()->route('provider.booking.custom-request.list',['custom_request_status'=>'Pending']);
        }
