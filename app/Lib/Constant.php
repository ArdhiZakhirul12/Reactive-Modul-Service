...
const PROVIDER_USER_TYPES = ['provider-admin', 'provider-employee', 'provider-serviceman','provider-KP','provider-accounting'];
const CUSTOMER_USER_TYPES = ['customer'];
const SERVICEMAN_USER_TYPES = PROVIDER_USER_TYPES[2];

const CUSTOM_REQUEST_TYPE = [
...
const USER_TYPES = [
    ...
    ['key' => 'provider-KP', 'value' => PROVIDER_USER_TYPES[3]],
    ['key' => 'provider-accounting', 'value' => PROVIDER_USER_TYPES[4]],
...
const BOOKING_STATUSES = [
    ...
    ['key' => 'pendingSparepart', 'value' => 'Pending Sparepart'],
    ['key' => 'servicemanDone', 'value' => 'Serviceman Done'],
    ['key' => 'reschedulingRequest', 'value' => 'Rescheduling Request'],
    ['key' => 'customerAgrees', 'value' => 'Customer Agrees'],
