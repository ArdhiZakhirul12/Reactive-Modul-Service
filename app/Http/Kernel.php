...
use Modules\ProviderManagement\Http\Middleware\AccountingMiddleware;
use Modules\ProviderManagement\Http\Middleware\AdminMiddleware as MiddlewareAdminMiddleware;
use Modules\ProviderManagement\Http\Middleware\KPMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'provider-admin' => MiddlewareAdminMiddleware::class,
        'provider-KP' => KPMiddleware::class,
        'provider-accounting' => AccountingMiddleware::class,
    ];
}
